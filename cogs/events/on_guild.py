...
Threads : {len(guild.threads)}
    ...
    embed = discord.Embed(
            ...
            description="\nFor support and updates, join our server: [Support Server](https://discord.gg/xscpUr5hPd).\n\n Find more information on our website: [Website](https://rawknee-portfolio.vercel.app).\n\n Invite the bot to other guilds: [Invite](https://discord.com/oauth2/authorize?client_id=1216994732803100764&permissions=8&scope=bot+applications.commands).\n\n Vote for us: [Vote](https://top.gg/bot/1079459656986005627/vote). We appreciate your support!\n\n - Rawknee.69",
            color=0x2f3136,
        )
