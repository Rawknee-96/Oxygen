...
from utils.Tools import getbadges
import os
import logging
from discord.ext import commands
...
from utils.config import server,NAME
...
class Extra(commands.Cog):
  ...
  async def invite(self, ctx: commands.Context):
    embed = discord.Embed(
      description=
      f"> <:anxDot:1108344311453593661> [Click Here To Invite Me To Your Server](https://discord.com/oauth2/authorize?client_id=1216994732803100764&permissions=8&scope=bot+applications.commands)\n> <:anxDot:1108344311453593661> [Click Here To Join My Support Server]({server})\n> <:anxDot:1108344311453593661>",
      color=0x2f3136)
    ...
    b = Button(
      ...
      url=
      'https://discord.com/oauth2/authorize?client_id=1216994732803100764&permissions=8&scope=bot+applications.commands'
    )
